...
class Joc:
    ...
    def mutari(self, jucator_opus):
        ...
        for index,val in enumerate(self.matr):
            if val == '#':
                copie = self.matr.copy()
                copie[index] = jucator_opus
                l_mutari.append(Joc(copie))
        return l_mutari
...
def min_max(stare):
    ...
    # calculez toate mutarile posibile din starea curenta + scadem adancimea
...
def main():
    ...
    while True:
        ...
        # --------------------------------
            ...
            #pune un break point aici sa vezi arborele
